...
RSpec.describe EventsController, type: :controller do
	...
	before do
    if Event.where(title: 'fake_title').empty?
    	Event.create(id: '1', title: 'fake_title', datetime: '12-12-2024 12:00:00', address: 'fake_address')           
    end
    if Guest.where(id: '1').empty?
    	Guest.create(id: '1', event_id: '1', first_name: 'fake_first_name_1', last_name: 'fake_last_name_1', email: 'fake_email_address_1')
    end
    if Guest.where(id: '2').empty?
    	Guest.create(id: '2', event_id: '1', first_name: 'fake_first_name_2', last_name: 'fake_last_name_2', email: 'fake_email_address_2')
    end
    if Guest.where(id: '3').empty?
    	Guest.create(id: '3', event_id: '1', first_name: 'fake_first_name_3', last_name: 'fake_last_name_3', email: 'fake_email_address_3')
    end
    end
